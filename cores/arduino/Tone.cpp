...
#if defined(TIMSK4) && !defined(__AVR_ATmega32U4__) && !defined(__AVR_ATmega16U4__)
...
const uint8_t PROGMEM tone_pin_to_timer_PGM[] = { 3, 1, 2, 0 };
...
static int8_t toneBegin(uint8_t _pin)
{
  ...
  if (_timer != -1)
  {
    ...
    switch (_timer)
    {
      ...
      #if defined(TCCR4A) && defined(TCCR4B) &&  defined(TIMSK4) && !defined(__AVR_ATmega32U4__) && !defined(__AVR_ATmega16U4__)
      case 4:
        // 16 bit timer
        TCCR4A = 0;
        TCCR4B = 0;
...
#endif
#if defined(TCCR4B) && !defined(__AVR_ATmega32U4__) && !defined(__AVR_ATmega16U4__)
      else if (_timer == 4)
...
#if defined(OCR4A) && defined(TIMSK4) && defined(OCIE4A) && !defined(__AVR_ATmega32U4__) && !defined(__AVR_ATmega16U4__)
      case 4:
        OCR4A = ocr;
...
#if !defined(__AVR_ATmega32U4__) && !defined(__AVR_ATmega16U4__) && !defined(__AVR_ATmega32U2__) && !defined(__AVR_ATmega16U2__) && !defined(__AVR_ATmega8U2__) && !defined(__AVR_AT90USB162__) && !defined(__AVR_AT90USB82__)
#if !defined(USE_RTC)
...
#if !defined(__AVR_ATmega32U2__) && !defined(__AVR_ATmega16U2__) && !defined(__AVR_ATmega8U2__) && !defined(__AVR_AT90USB162__) && !defined(__AVR_AT90USB82__)
...
#if !defined(__AVR_ATmega32U4__) && !defined(__AVR_ATmega16U4__) && !defined(__AVR_ATmega32U2__) && !defined(__AVR_ATmega16U2__) && !defined(__AVR_ATmega8U2__) \
    && !defined(__AVR_AT90USB162__) && !defined(__AVR_AT90USB82__) && !defined(__AVR_AT90USB646__) && !defined(__AVR_AT90USB1286__) && !defined(__AVR_AT90USB647__) && !defined(__AVR_AT90USB1287__)
